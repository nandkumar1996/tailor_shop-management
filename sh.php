...
<div class="signup-form">
    <form action="include/shirt.inc.php" method="POST">
		...
		<div class="form-group">
		 ...
		 <div class="row">
		 <div class="col-xs-6"><input type="text" class="form-control" name="collar" placeholder="Collar(cm)"></div>
		 <div class="col-xs-6"><input type="text" class="form-control" name="sleeve" placeholder="Sleeve(cm)"></div>
		 </div>
		 <div class="row">
		 <div class="col-xs-6"><input type="text" class="form-control" name="cuffing" placeholder="Cuffing(cm)"></div>
		 <div class="col-xs-6"><input type="text" class="form-control" name="chest" placeholder="Chest(cm)"></div>
		 </div>
		 <div class="row">
		 <div class="col-xs-6"><input type="text" class="form-control" name="neck" placeholder="Neck(cm)"></div>
		 <div class="col-xs-6"><input type="text" class="form-control" name="length" placeholder="Length(cm)"></div>
		 </div>
		 <div class="form-group">
