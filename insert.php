					...
					else
					{
						if(!preg_match("/^[0-9]*$/",$mobile))
						{
                         ...
                         else
						 {
							 ...
							 {
								  $sql = "INSERT INTO cus_pant_details(cus_first,cus_last,cus_email,cus_mob,cus_address,cus_west,cus_thigh,cus_length) values('$first','$last','$email','$mobile','$address','$west','$thigh','$length');";
